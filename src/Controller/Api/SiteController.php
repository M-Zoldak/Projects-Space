...
class SiteController extends AbstractController {
    ...
    #[Route('/site', name: 'app_api_site_add', methods: ["POST"])]
    ...
    #[Route('/sites', name: 'app_api_site_overview', methods: ["GET"])]
