 ...
 */
final class Version20231204204549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_notification (id INT NOT NULL, user_id INT DEFAULT NULL, icon VARCHAR(1024) DEFAULT NULL, message VARCHAR(2048) NOT NULL, INDEX IDX_3F980AC8A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
