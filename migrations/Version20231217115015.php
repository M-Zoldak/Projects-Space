 ...
 */
final class Version20231217115015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT NOT NULL, app_id INT DEFAULT NULL, client_id INT DEFAULT NULL, website_id INT DEFAULT NULL, project_state_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, participants JSON DEFAULT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, INDEX IDX_2FB3D0EE7987212D (app_id), INDEX IDX_2FB3D0EE19EB6921 (client_id), INDEX IDX_2FB3D0EE18F45C82 (website_id), INDEX IDX_2FB3D0EE3896B71A (project_state_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE task (id INT NOT NULL, project_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, start_date DATETIME DEFAULT NULL, end_date DATETIME DEFAULT NULL, category VARCHAR(255) NOT NULL, INDEX IDX_527EDB25166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
